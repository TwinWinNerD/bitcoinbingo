(function() {
    if (!Modernizr.websockets || !Modernizr.localstorage) {
        return $("body").empty().html('<p class="browsehappy">You are using an <strong>outdated</strong> browser. Please <a href="http://browsehappy.com/">upgrade your browser</a> to use this website.</p>');
    }
